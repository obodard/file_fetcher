"""LocalFile ORM model — tracks locally-owned media files."""
...
class LocalFile(Base):
    """A media file that exists on the local filesystem."""
    ...
    def __repr__(self) -> str:  # pragma: no cover
        return f"<LocalFile id={self.id} path={self.local_path!r}>"
